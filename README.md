...
|-----------------------------|---------------------|----------|:------------:|
| 2.0.1-SNAPSHOT              | 1.0.0.RC1 -> 1.0    |  2.5.3   |  XXXX-XX-XX  |
| 2.0.0                       | 1.0.0.RC1 -> 1.0    |  2.5.3   |  2014-03-07  |
| 2.0.0.RC1                   | 1.0.0.RC1 -> 1.0    |  2.5.3   |  2014-01-15  |

Please read documentation relative to the version you are using:

* [2.0.1-SNAPSHOT](https://github.com/elasticsearch/elasticsearch-lang-python/blob/es-1.0/README.md)
* [2.0.0](https://github.com/elasticsearch/elasticsearch-lang-python/blob/v2.0.0/README.md)
* [2.0.0.RC1](https://github.com/elasticsearch/elasticsearch-lang-python/blob/v2.0.0.RC1/README.md)
